	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				...
				<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;">Цена за 1шт</th>
		...
		<tfoot>
			...
			if ( $item_totals ) {
				...
				foreach ( $item_totals as $total ) {
					...
					?>
					<tr>
						<th class="td" colspan="2" scope="row" colspan="2" style="text-align:<?php echo esc_attr( $text_align ); ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>"><?php echo wp_kses_post( $total['label'] ); ?></th>
